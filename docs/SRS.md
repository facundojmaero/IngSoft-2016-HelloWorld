...
#### 3.1 Requerimientos funcionales
Se listan los requerimientos funcionales del sistema, seguido de gráficos explicativos de cada uno de ellos:
...
- **2. Cambio de modelo:** El sistema deberá permitir cambiar el modelo utilizado en tiempo de ejecución.
    ...
    - 2.2 La funcionalidad de cada modelo funcionará hasta que se cambie el mismo, momento donde se detiene para dar lugar a la siguiente.
...
- **5. Eliminar canciones:** El sistema deberá permitir borrar las canciones que estén en la playlist.
    - 5.1. El sistema deberá permitir eliminar de a una canción en la playlist, seleccionando la misma con el mouse.
...
- **10. Saltear canciones:** El sistema deberá permitir reproducir la canción siguiente o anterior a la actual.
    ...
    - 10.2 El sistema deberá tener una lista de reproducción circular.
    - 10.3 Si se intenta reproducir la canción siguiente a la última, el sistema deberá comenzar con la primera de la lista.
    - 10.4 Si se intenta reproducir la canción anterior a la primera, el sistema deberá comenzar con la última de la lista.
...
- **11. Mostrar información:** El sistema debería mostrarle al usuario la información de la canción que se está reproduciendo en una ventana emergente.
    ...
    - 11.3 El sistema no permitirá abrir múltiples ventanas de información de pista.
    - 11.4 Al presionar más de una vez el botón para mostrar la información, se abrirá y cerrará la misma ventana respectivamente.


- **12. Mostrar portada:** El sistema debería mostrar la portada del álbum que se está reproduciendo.
    - 12.1 Se debería proveer una interfaz para mostrar la portada del álbum de la canción actual.
    - 12.2 No se permitirá abrir más de una instancia de la ventana del álbum.
    - 12.3 Si se presiona más de una vez el botón para ver la portada, se abrirá y cerrará la misma ventana respectivamente.
